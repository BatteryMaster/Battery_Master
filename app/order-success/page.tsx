  ...
  return (
    <div className="wrap" style={{ padding:"60px 0 80px" }}>
      <div style={{ maxWidth:560, margin:"0 auto", textAlign:"center" }}>
        ...
        <h1 style={{ fontSize:"clamp(22px,4vw,30px)", fontWeight:900, color:"#0f172a", marginBottom:10 }}>Order Placed Successfully!</h1>
        <p style={{ color:"#64748b", fontSize:15, lineHeight:1.7, marginBottom:4 }}>Thank you! Your order has been received.</p>
        <p style={{ color:"#64748b", fontSize:13, lineHeight:1.7, marginBottom:24 }}>A WhatsApp window should have opened — please send the message to confirm your order and receive payment details.</p>
        ...
        <div style={{ background:"#f0fdf4", border:"1.5px solid #bbf7d0", borderRadius:14, padding:"20px 24px", marginBottom:24, textAlign:"left" }}>
          ...
          <div style={{ fontSize:13, color:"#374151", marginTop:14, lineHeight:2 }}>
            ✅ Order received<br/>
            📱 Send WhatsApp message for payment details<br/>
            📞 We will confirm within 30 minutes<br/>
            🚚 Karachi: delivery in 1–2 days
          </div>
        </div>

        <a href="https://wa.me/923329891510" target="_blank" rel="noopener noreferrer"
          style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:8, padding:"13px 28px", background:"#25D366", color:"#fff", borderRadius:10, fontSize:15, fontWeight:800, textDecoration:"none", marginBottom:12, width:"100%", boxSizing:"border-box", boxShadow:"0 4px 16px rgba(37,211,102,0.3)" }}>
          ...
          Send WhatsApp Message: 03329891510
        </a>

        <div style={{ display:"flex", gap:10, justifyContent:"center", flexWrap:"wrap" }}>
          <Link href="/" style={{ padding:"11px 24px", background:"#16a34a", color:"#fff", borderRadius:8, fontSize:14, fontWeight:700, textDecoration:"none" }}>
            🏠 Home
          </Link>
