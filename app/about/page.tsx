...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn more about Electrofy.pk, a fast electronics ecommerce website in Pakistan for modules, ICs, transistors, resistors, and tools.",
};
    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mt-8 space-y-6 text-lg leading-8 text-gray-600">
          <p>
            Electrofy.pk is a modern electronics ecommerce store built for
          ...
          <p>
            We are building Electrofy.pk with a focus on clear product
          ...
          <p>
            ...
            sourcing repair components, Electrofy.pk aims to become your trusted
            electronics partner.
          </p>
        </div>
      </section>
