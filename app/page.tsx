      ...
      <section style={{ background:"linear-gradient(135deg, #0f172a 0%, #1e3a8a 50%, #1e40af 100%)", padding:"72px 0 80px", position:"relative", overflow:"hidden" }}>
        ...
        <div className="wrap" style={{ position:"relative", textAlign:"center" }}>
          ...
          <p style={{ fontSize:16, color:"rgba(255,255,255,0.62)", lineHeight:1.8, maxWidth:520, margin:"0 auto 36px" }}>
            JK BMS · LiFePO4 Cells · E-Bike Kits · Lithium Packs · Chargers · LCD Displays · Silicon Wires & Terminals — all in one place
          </p>
      ...
      {hotProducts.length > 0 && (
        <section style={{ padding:"60px 0 0" }}>
          <div className="wrap">
            ...
            <div className="prod-grid" style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))", gap:16 }}>
        ...
        <div className="wrap">
          ...
          {filtered.length === 0 && (
            <div style={{ textAlign:"center", padding:"60px 20px", color:"#94a3b8" }}>
              ...
              <div style={{ fontSize:16, fontWeight:600 }}>No products found in this category</div>
            </div>
          )}
        </div>
      </section>
      ...
      <section style={{ padding:"64px 0", background:"#fff", borderTop:"1.5px solid #e2e8f0" }}>
        <div className="wrap">
          <div style={{ textAlign:"center", marginBottom:40 }}>
            ...
            <h2 style={{ fontSize:"clamp(20px,3vw,28px)", fontWeight:800, color:"#0f172a", marginTop:4 }}>How to Order</h2>
          </div>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))", gap:16 }}>
            {[
              ...
              { n:"04", t:"Receive Delivery", d:"Karachi: delivery in 1-2 days. Courier available across Pakistan." },
            ].map(h => (
          ...
          <div style={{ background:"linear-gradient(135deg,#0f172a 0%,#1e3a8a 100%)", borderRadius:16, padding:"48px 40px", display:"grid", gridTemplateColumns:"1fr auto", gap:32, alignItems:"center", position:"relative", overflow:"hidden" }}>
            ...
            <div style={{ position:"relative" }}>
              ...
              <p style={{ color:"rgba(255,255,255,0.55)", lineHeight:1.75, fontSize:14, maxWidth:480 }}>
                Karachi: 1–2 days, courier available across Pakistan. WhatsApp us or order from the website.
              </p>
            </div>
