      ...
      <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="hidden items-center gap-6 md:flex">
            ...
            <Link href="/cart" className="relative flex items-center gap-2 rounded-2xl bg-blue-600 px-5 py-2.5 font-semibold text-white shadow-sm transition hover:bg-blue-700">
