      ...
      <div className="wrap footer-grid" style={{
        ...
        <div>
          ...
          <div style={{ marginTop:16, fontSize:13, color:"rgba(255,255,255,0.40)", lineHeight:2.1 }}>
            ...
            <div style={{ paddingLeft:22, fontSize:11, color:"rgba(255,255,255,0.28)" }}>Near Regal Chowk, Saddar, Karachi</div>
          ...
          <a href="https://wa.me/923150220243" target="_blank" rel="noopener noreferrer"
            style={{ display:"inline-flex", alignItems:"center", gap:8, marginTop:16, background:"#25D366", color:"#fff", borderRadius:8, padding:"10px 18px", fontSize:13, fontWeight:700 }}>
