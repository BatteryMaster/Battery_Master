...
export default function ProductCard({ id, name, category, price, stock, image, badge = null, originalPrice }: Props) {
  ...
  // Safe fallback — agar stock undefined ho toh crash na ho
  ...
  return (
    <div className="prod-card">
      ...
      <Link
        ...
        style={{ position:"relative", display:"block", height:190, background:"#eef2ff", flexShrink:0, overflow:"hidden" }}
      >
        <Image
      ...
      {/* Body */}
      <div className="prod-card-body" style={{ padding:"14px", flex:1, display:"flex", flexDirection:"column", gap:6 }}>
        ...
        <Link href={`/shop/${id}`}>
          <h3
            ...
            style={{ fontSize:13.5, fontWeight:600, color:"#0f172a", lineHeight:1.45, display:"-webkit-box", WebkitLineClamp:2, WebkitBoxOrient:"vertical", overflow:"hidden", minHeight:40 }}
          >{name}</h3>
        </Link>
        ...
        <div style={{ display:"flex", gap:7, marginTop:"auto", paddingTop:8 }}>
          ...
          <Link
            href={`/shop/${id}`}
            style={{ display:"flex", alignItems:"center", justifyContent:"center", width:38, height:38, background:"#eef2ff", border:"1.5px solid #e2e8f0", borderRadius:7, color:"#475569", flexShrink:0 }}
          >
