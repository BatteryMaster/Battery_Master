export default function WebsiteSchema() {
  const schema = {
    ...
    "@graph": [
      {
        "@type": "Organization",
        "@id": "https://batterymaster.pk/#organization",
        ...
        sameAs: ["https://wa.me/923329891510"],
        contactPoint: {
          "@type": "ContactPoint",
      ...
      {
        "@type": "WebSite",
        "@id": "https://batterymaster.pk/#website",
        url: "https://batterymaster.pk",
        name: "batterymaster.pk — Electronics Components in Pakistan",
        description: "Buy Arduino, modules, ICs, transistors, resistors and tools in Pakistan. Fast delivery in Karachi.",
        publisher: { "@id": "https://batterymaster.pk/#organization" },
        potentialAction: {
          "@type": "SearchAction",
          target: { "@type": "EntryPoint", urlTemplate: "https://batterymaster.pk/shop?q={search_term_string}" },
